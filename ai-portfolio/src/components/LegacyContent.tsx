        ...
        <div className="container">
            ...
            <div className="services-grid">
                <div className="service-card-v2 reveal">
                    <div className="service-icon-wrap" style={{'--svc-color': '#3b82f6'}}><i className="fa-solid fa-briefcase"></i></div>
                ...
                <div className="service-card-v2 reveal delay-1">
                    <div className="service-icon-wrap" style={{'--svc-color': '#8b5cf6'}}><i className="fa-solid fa-rocket"></i></div>
                    <h3>Landing Pages</h3>
                ...
                <div className="service-card-v2 reveal delay-2">
                    <div className="service-icon-wrap" style={{'--svc-color': '#06b6d4'}}><i className="fa-solid fa-layer-group"></i></div>
                ...
                <div className="service-card-v2 reveal delay-3">
                    <div className="service-icon-wrap" style={{'--svc-color': '#10b981'}}><i className="fa-solid fa-chart-line"></i></div>
                ...
                <div className="service-card-v2 reveal delay-4">
                    <div className="service-icon-wrap" style={{'--svc-color': '#f59e0b'}}><i className="fa-brands fa-wordpress-simple"></i></div>
                ...
                <div className="service-card-v2 reveal delay-5">
                    <div className="service-icon-wrap" style={{'--svc-color': '#ef4444'}}><i className="fa-solid fa-server"></i></div>
